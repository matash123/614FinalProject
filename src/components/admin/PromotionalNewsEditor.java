...
//[1] OpenAI. (2025). Code generated by ChatGPT (GPT-5 model) for PromotionalNewsEditor.java. Retrieved November 29, 2025, from https://chat.openai.com/
...
public class PromotionalNewsEditor extends DynamicPanel {
    ...
    private void populateForm(Promotion promo) {
        ...
        startDateField.setText(promo.getStartDate() != null ? promo.getStartDate().toString() : "");
        endDateField.setText(promo.getEndDate() != null ? promo.getEndDate().toString() : "");
    }
    ...
    private void handleSave() {
        ...
        if (startDateStr == null || startDateStr.isBlank() || startDateStr.contains("%")) {
            JOptionPane.showMessageDialog(
                this,
                "Please enter a valid start date in the form yyyy-mm-dd.",
                "Validation error",
                JOptionPane.WARNING_MESSAGE
            );
            return;
        ...
        if (endDateStr == null || endDateStr.isBlank() || endDateStr.contains("%")) {
            JOptionPane.showMessageDialog(
                this,
                "Please enter a valid end date in the form yyyy-mm-dd.",
                "Validation error",
                JOptionPane.WARNING_MESSAGE
            );
            return;
