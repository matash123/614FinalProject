...
public class AdminFlightEditorPanel extends DynamicPanel {
    ...
    private void buildForm() {
        ...
        // Flight ID (read-only; primary key). For new flights this will be
        // auto-generated by the controller/CRUD layer on save.
        JLabel idLabel = new JLabel("Flight ID (auto-generated):");
    ...
    private void populateFromFlight() {
        if (originalFlight == null) {
            // New flight – fields start empty; ID will be generated on save.
        ...
        // Existing flight – show current ID.
    ...
    private void handleSave() {
        // For existing flights we reuse the current ID; for new flights we let
        // the controller/CRUD layer generate a unique ID when flightId is null/blank.
        ...
        try {
            Flight saved = adminFlightController.createOrUpdateFlight(
                flightId,
                airline,
                airplane,
                origin,
            ...
            // If this was a new flight, update the (read-only) ID field with
            // the generated identifier so admins can see it after save.
            if (originalFlight == null && saved != null) {
                flightIdField.setText(saved.getFlightId());
            }
