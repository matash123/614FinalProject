...
public class PaymentCRUD {
    ...
    private static Payment mapRow(ResultSet rs) throws SQLException {
        ...
        // Now to connect payment to reservation (the specific object), we are pulling teh getReservationID 
        //which after a ton of thought and eep understand we designed to actually return a new object of the reservation
        //from the Db landscape to JAVA, and this object is built at the time of call with all the info in the DB at that instance.
        FlightCustomerReservation reservation =
                ReservationCRUD.getReservationById(reservationId);
